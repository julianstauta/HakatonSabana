...
public class RedimePuntos extends JFrame{
	...
	private JLabel labMensaje = new JLabel("Redime tus puntos!!", SwingConstants.CENTER);
	private JLabel labSitios = new JLabel("", SwingConstants.CENTER);
	...
	public RedimePuntos(Principal ventana){
		super("Redimir Puntos");
		principal = ventana;
		...
		Icon ic = new ImageIcon( "Img/sitios.jpg" );
		labSitios.setIcon(ic);
		add(labSitios, BorderLayout.SOUTH);
	...
	public void AbrirEstadisticas() {
		estadisticas = new Estadisticas(principal);
		setVisible(false);
